        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="logout-form" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Короткое описание (необязательно)" aria-label="Короткое описание" aria-describedby="basic-addon1" name="comment" autocomplete="off" value="{{old('comment')}}">
                      </div>
